						...
						<li className="otherCards__item">
							<div className="otherCards__item__info" style={{backgroundColor:"#FDC3BB"}}>
								...
								<h5 className="otherCards__item__text"><p>
									...
									have the ownership and a big say in how the Netlight brand should look like. Since we are self driven 
									there is a lot of responsibility involved and one could say that we adapt a UX mindset to our work. I consult stakeholders 
									about what their vision is for a certain design, do research on the subject, handle feedback and motivate my design decisions 
									and deliver to a deadline. In my role I have gained knowledge about Netlight's graphic profile 
