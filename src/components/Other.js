						...
						<li className="otherCards__item">
							<div className="otherCards__item__info" style={{backgroundColor:"#FDC3BB"}}>
								...
								<h5 className="otherCards__item__text"><p>
									...
									a lot of responsibility involved and one could say that we adapt a UX mindset to our work. In my roles I consult 
									...
									to go with it. I have also had the opportunity to onboard new team members and thereby trained my pedagogic skills. 
