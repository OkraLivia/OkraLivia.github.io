	        ...
	        <div className='about-link-wrapper'>
	          ...
	          <h4 className='technologies'>ADOBE XD | REDESIGN | IPHONE APP</h4>
	            <h1 className="title" style={{marginBottom: "10px"}}>Redesign of the app Clue</h1>
				   <p><h4>This is a project I did in my freetime using Adobe XD. I thought it would be a fun and 
				   ...
				   to think about and discover areas that in my opinion need some improvement.</h4></p>
	          </div>
