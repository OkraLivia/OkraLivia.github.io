	        ...
	        <div className='about-link-wrapper'>
	          ...
	          <h4 className='technologies'>HAPTICS | GAME DEVELOPMENT | ANDROID</h4>
	            <h1 className="title" style={{marginBottom: "10px"}}>Hunt the Thimble</h1>
				   <p>In this project we investigated the difference in performance and whether or not the 
				   ...
				   feedback combined with visual feedback, vibrotactile feedback only and lastly visual feedback only.</p>
				   <br/>
				   <p>This app is the outcome from a group project of two people in the course Haptic, Tactile 
				   ...
				   project I designed the vibration patterns and the UI.</p>
	          </div>
