	          ...
	          <h4 className='technologies'>COLOR COMBINATIONS | USER RESEARCH | UI DESIGN</h4>
	            <h1 className="title" style={{marginBottom: "10px"}}>Perception Project</h1>
				   <p>Different colors can be used for evoking different emotions and associations and is an important factor when
				    ...
				    as harmonic, while the color schemes with contrasting colors were mostly perceived as chaotic.</p>
				   <br /> 
				   <p>This study is the outcome from a group project of four people in the course Human Perception for Information 
				   technology at KTH. In this project I worked with the appearance of the webpage and with user tests and analysing the collected data.</p>
