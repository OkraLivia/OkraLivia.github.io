	        ...
	        <div className='about-link-wrapper'>
	          <div className='about-link-items'>
	            ...
	            <h1 className="title" style={{marginBottom: "10px"}}>Cozy Corners</h1>
				   <p><h4>Cozy Corners makes sharing your favourite places easier. A user with a profile can add a new 
				   ...
				   without a profile.</h4></p>
				   <br/>
				   <p><h4>Cozy Corners is the outcome from a group project of three people in the course Mobile Development 
