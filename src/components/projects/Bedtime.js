	        ...
	        <div className='about-link-wrapper'>
	          ...
	          <h4 className='technologies'>UX DESIGN | USER RESEARCH | PROBES</h4>
	            <h1 className="title" style={{marginBottom: "10px"}}>Bedtime</h1>
				   ...
				   Evaluation at KTH. To creat this experience I used interviews, probes, moodboards, hybridsketching and finally Adobe After 
	          ...
	          <div style={{marginTop: '5em'}}>
	            {/*<iframe title="Bedtime presentation" src="images/Bedtime - Okra Livia Inkeri Dimle.pdf" frameborder="0" 
	             ...
	             <embed className='bedtimePDF' title="Bedtime presentation" src="images/Bedtime - Okra Livia Inkeri Dimle.pdf#toolbar=0&navpanes=0&scrollbar=0"  width="600px" 
