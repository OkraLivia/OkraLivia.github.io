...
const imgTexts = [
  ...
  'The inspiration for this comes from an Instagram post I saw, it is a poster of things that I appreciate: sauna, swimming in the ocean, art, plants, coffee, strawberry cake and craft beer. It says "Enjoyt the little things" in Finnish and "A collection of moments" in Swedish.',
  ...
  'This illustration I made in Illustratior and it is an entry in a color palette challenge where the task is to create an artwork only using a predetermined and limited color palette.',
  'This is the invitation I made with and Uni Pin fineliners and aquarelle for the celebration of me graduating from high school.',
